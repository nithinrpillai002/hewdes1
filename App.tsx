...
const App: React.FC = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case Page.CRM:
        return <CRM products={products} rules={rules} setRules={setRules} kieApiKey={kieApiKey} />;
      case Page.SETTINGS:
        return <Settings apiKey={kieApiKey} setApiKey={setKieApiKey} darkMode={darkMode} setDarkMode={setDarkMode} />;
      default:
        return <CRM products={products} rules={rules} setRules={setRules} kieApiKey={kieApiKey} />;
    }
  };
